...
object TonePromptDto {
    @Schema(description = "톤 프롬프트 응답 DTO")
    data class ResponseModel(
        @field:Schema(description = "톤 프롬프트 ID", example = "tp_123456")
        val id: String,

        @field:Schema(description =  "프롬프트 버전 ID", example = "334324523543")
        val promptVersionId: String,

        @field:Schema(description = "톤 프롬프트 내용", example = "공감적이고 따뜻한 어조로 대화하세요.")
        val body: String,
    ...
    data class FindByIdResponse(
        @field:Schema(description = "톤 프롬프트")
        val tonePrompt: ResponseModel,
    )
    ...
    data class FindResponse(
        @field:Schema(description = "톤 프롬프트 목록")
        val tonePrompts: List<ResponseModel>,
    )
